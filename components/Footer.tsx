      ...
      <div className="container-wide py-10 grid gap-8 md:grid-cols-3">
        <div>
          ...
          <p className="mt-3">
            <a
              className="link"
              href="https://maps.google.com?q=NE476AB"
              target="_blank"
              rel="noreferrer"
            >
              Get directions
        ...
        <div>
          ...
          <p className="mt-2">
            <span className="block font-semibold">Daily</span>
            Breakfast: 5:00–9:00
            <br />
            Lunch: 12:00–14:00
            <br />
          ...
          <div className="mt-3 flex items-center gap-3">
            ...
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
                <path d="M7 2h10a5 5 0 015 5v10a5 5 0 01-5 5H7a5 5 0 01-5-5V7a5 5 0 015-5zm0 2a3 3 0 00-3 3v10a3 3 0 003 3h10a3 3 0 003-3V7a3 3 0 00-3-3H7zm5 3.5A5.5 5.5 0 1112 18.5 5.5 5.5 0 0112 7.5zm0 2a3.5 3.5 0 103.5 3.5A3.5 3.5 0 0012 9.5zM18 6.2a1 1 0 11-1 1 1 1 0 011-1z" />
              </svg>
            </a>
            <a
              className="social"
            ...
            >
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
                <path d="M13 22v-8h3l1-4h-4V8a1 1 0 011-1h3V3h-3a5 5 0 00-5 5v2H6v4h3v8z" />
              </svg>
            </a>
          </div>
        </div>
