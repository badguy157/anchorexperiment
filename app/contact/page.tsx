    ...
    <>
      ...
      <section className="page-section">
        <div className="grid gap-6 md:grid-cols-2">
          {/* Message form (no backend; just a pretty form) */}
          <div className="page-card">
            <h3 className="text-xl font-semibold">Send us a message</h3>
            <form className="mt-4 space-y-4" onSubmit={(e)=>e.preventDefault()}>
              <div>
                <label className="block text-sm font-medium text-timber/80">Name</label>
                <input className="mt-1 w-full rounded-lg border border-stone/60 bg-white/95 px-3 py-2" placeholder="Your name" />
              </div>
              <div>
                <label className="block text-sm font-medium text-timber/80">Email</label>
                <input type="email" className="mt-1 w-full rounded-lg border border-stone/60 bg-white/95 px-3 py-2" placeholder="you@example.com" />
              </div>
              <div>
                <label className="block text-sm font-medium text-timber/80">Message</label>
                <textarea rows={6} className="mt-1 w-full rounded-lg border border-stone/60 bg-white/95 px-3 py-2" placeholder="How can we help?" />
              </div>
